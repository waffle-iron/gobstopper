defmodule Gobstopper.API.Auth.Email do
    ...
    @doc """
      ...
      error.
    """
    @spec register(String.t, String.t) :: { :ok, token } | { :error, String.t }
    ...
    @doc """
      ...
      returns an error.
    """
    @spec get(token) :: { :ok, { :unverified | :verified, String.t } | { :none, nil } } | { :error, String.t }
    def get(token) do
    ...
    """
    @spec set(token, String.t, String.t) :: :ok | { :error, String.t }
    ...
    """
    @spec remove(token) :: :ok | { :error, String.t }
